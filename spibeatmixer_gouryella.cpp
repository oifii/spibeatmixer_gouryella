...
int main(int argc, char *argv[])
{
	...
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\ProSamples.28.Vocal.House.Samples.WAV.part1\\WAV All_Vocals\\WAV adlibs";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Top Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Synth Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Percussion Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Drum Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Bass Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Output - Deep Bass House\\Fx";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Synth Loops\\Bass Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Synth Loops\\Chord Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Synth Loops\\Lead Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Drum Loops\\120 BPM";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Drum Loops\\122 BPM";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\Drum Loops\\123 BPM";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\FX\\Atmoshpere";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\FX\\Downlifters";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\FX\\Reverse FX";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\FX\\Risers";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Sample Science -Deep House Megapack\\FX\\Uplifters";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Class.A.Samples.Deep.and.Tech.House.Sale.Pack\\Afro House by Class A Samples";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Class.A.Samples.Deep.and.Tech.House.Sale.Pack\\Futuristic Deep House by Sample Tweakers";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Class.A.Samples.Deep.and.Tech.House.Sale.Pack\\Old School Deep House by Class A Samples";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Class.A.Samples.Deep.and.Tech.House.Sale.Pack\\Percussion Loops by 99 Patches";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Class.A.Samples.Deep.and.Tech.House.Sale.Pack\\Total House Drums by Class A Samples";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Euphoric Trance Melodies - Loops And Midis\\LOOPS 137BM";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Function.Loops.Spirit.Progressive.Trance.and.Psy.WAV\\SYNTH";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Equinox_Sounds_-_Psy_Trance_Explorations_Bundle_Vols_1-3\\PSY_TRANCE_EXPLORATIONS_2\\WAV\\Loops\\Drum_Loops";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Samplephonics.Psychedelic.Guitars\\Wav_SP\\120bpm Ethos";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\Samplephonics.Psychedelic.Guitars\\Wav_SP\\90bpm Guru";
	...
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\ProSamples.28.Vocal.House.Samples.WAV.part1\\WAV Loops\\WAV percussionloops\\WAV mixpercussion";
	//string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\ProSamples.28.Vocal.House.Samples.WAV.part1\\WAV Loops\\WAV percussionloops\\WAV congaloops";
			...
			for(it=pInstrumentSet->instrumentvector.begin();it<pInstrumentSet->instrumentvector.end();it++)
			{
				...
				if(pAnInstrument2)
				{
					...
					if(pAWavSet2)
					{
						...
						//pSilentWavSet->SpreadSample("1011010010101000", pAWavSet2, loopduration_s, 5, 0.0); //pattern over loopduration_s sec, sample duration 5sec and with pattern offset of 0sec;// pAWavSet2
	...
	for(int i=0; i<100; i++) //repeat 100 times
	{
		if(pInstrumentSet && pInstrumentSet->HasOneInstrument()) 
		{
			...
			//{
				...
				///////////////////////////////////////////////////////////////////
				//spread another smaller-scale sample, in this case, ekhart's voice
				///////////////////////////////////////////////////////////////////
				/*
				Instrument* pAnInstrument2 = pInstrumentSet2->GetInstrumentRandomly();
				if(pAnInstrument2)
